    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow space-y-4">
          <h2 className="text-xl font-bold">{editingId ? 'Modifier la dépense' : 'Nouvelle dépense'}</h2>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Produit associé (optionnel)</label>
              <select
            ...
            <div className="col-span-2">
              <label className="block text-sm font-medium mb-1">Lien de la facture PDF (optionnel)</label>
              <input
                type="url"
          ...
          <tbody className="divide-y divide-gray-200">
            {expenses.map((expense) => (
              <tr key={expense.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex gap-2">
                    <button onClick={() => editExpense(expense)} className="text-blue-600 hover:text-blue-800">
                      Modifier
                    </button>
